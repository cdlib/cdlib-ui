module.exports = {
  ...
  sample6: {
    link: {
      text: 'Link to PDF file',
      url: 'sample-url/document.pdf'
    }
  },
  sample7: {
    link: {
  ...
  sample8: {
    link: {
      text: 'Link to Word file',
      url: 'sample-url/document.doc'
    }
  },
  sample9: {
    link: {
      text: 'Link to Excel spreadsheet',
      url: 'sample-url/document.xls'
    }
  },
  sample10: {
    link: {
      text: 'Link to text file',
      url: 'sample-url/document.txt'
    }
  },
  sample11: {
    link: {
      text: 'Link to Zip file',
      url: 'sample-url/document.zip'
    }
  },
  sample12: {
    link: {
